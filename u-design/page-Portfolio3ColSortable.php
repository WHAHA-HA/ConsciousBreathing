 ...
 */
/**
 * Template Name: Portfolio page 3 Columns Sortable
 */
...
<div id="content-container" class="isotoope-portfolio-wrapper portfolio-3-column-sortable-page">
...
?>
			<div class="one_third_isotope portfolio-category <?php echo $classes_identifiers; ?> <?php echo $tags_names; ?>">
