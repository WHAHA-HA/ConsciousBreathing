...
<?php		    // Widgetized sidebar
			...
			<div class="custom-formatting">
			    ...
			    <ul>
				<?php _e("To edit this sidebar, go to admin backend's <strong><em>Appearance -> Widgets</em></strong> and place widgets into the <strong><em>Pages Sidebar 5</em></strong> Widget Area", 'udesign'); ?>
			    </ul>
			</div>
