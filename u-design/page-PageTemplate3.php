 ...
 */
/**
 * Template Name: Page Template 3
 */
if ( !defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

get_header();

$content_position = ( $udesign_options['pages_sidebar_3'] == 'left' ) ? 'grid_16 push_8 ' : 'grid_16';
?>
...
<?php if( sidebar_exist('PagesSidebar3') ) { get_sidebar('PagesSidebar3'); } ?>
