...
<!--
 ...
 -->
    ...
    <?php
    	//test video length using
    	//Method Name:vimeo.videos.getInfo
    	//

    	//$videos = $vimeo->call('vimeo.videos.getInfo', array('video_id' => '97760848','format'=>'json'));
    $videos = $vimeo->call('vimeo.videos.getInfo', array('video_id' => '97760848'));
    ...
    ?>
        ...
        <?php
        	print_r($videos->video[0]->duration);
        	$duration = $vidoes->video[0]->duration;
        ?>
   		 <?php endif ?>
